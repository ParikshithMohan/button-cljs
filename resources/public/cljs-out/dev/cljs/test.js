...
var G__14809 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14809,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14809;
}
});
...
var len__4531__auto___14814 = arguments.length;
var i__4532__auto___14815 = (0);
while(true){
if((i__4532__auto___14815 < len__4531__auto___14814)){
args__4534__auto__.push((arguments[i__4532__auto___14815]));

var G__14816 = (i__4532__auto___14815 + (1));
i__4532__auto___14815 = G__14816;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14811){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14812,G__14813,seq14811__$2);
});
...
var file = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14818__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14818,map__14818__$1,file,line,column){
return (function (p1__14817_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14817_SHARP_));
});})(map__14818,map__14818__$1,file,line,column))
...
var temp__5457__auto___14820 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14820)){
var message_14821 = temp__5457__auto___14820;
cljs.core.println.call(null,message_14821);
} else {
}
...
var temp__5457__auto___14822 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14822)){
var message_14823 = temp__5457__auto___14822;
cljs.core.println.call(null,message_14823);
} else {
}
...
var output_dir__$1 = (function (){var G__14824 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14824),"/"].join('');
} else {
return G__14824;
}
})();
...
var G__14826 = exception.stack;
var G__14826__$1 = (((G__14826 == null))?null:clojure.string.split_lines.call(null,G__14826));
var G__14826__$2 = (((G__14826__$1 == null))?null:cljs.core.get.call(null,G__14826__$1,depth));
if((G__14826__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14826__$2);
}
} else {
...
var vec__14827 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14827,(0),null);
var column = cljs.core.nth.call(null,vec__14827,(1),null);
var vec__14830 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14830,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14830,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14830,(2),null);
...
var m__$1 = (function (){var G__14833 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14837 = (function (){var G__14836 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14836);
} else {
return G__14836;
}
})();
...
return cljs.core.vary_meta.call(null,G__14838,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14842 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14842,(0),null);
var types = vec__14842;
...
return cljs.core.map.call(null,(function (p__14845){
var vec__14846 = p__14845;
var ns = cljs.core.nth.call(null,vec__14846,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14846,(1),null);
return ((function (vec__14846,ns,vars__$1){
return (function (){
...
var G__14849 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1){
return (function (){
var seq__14850 = cljs.core.seq.call(null,vars__$1);
var chunk__14851 = null;
var count__14852 = (0);
var i__14853 = (0);
while(true){
if((i__14853 < count__14852)){
var v = cljs.core._nth.call(null,chunk__14851,i__14853);
var temp__5457__auto___14855 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14855)){
var t_14856 = temp__5457__auto___14855;
each_fixture_fn.call(null,((function (seq__14850,chunk__14851,count__14852,i__14853,t_14856,temp__5457__auto___14855,v,each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14856)));
});})(seq__14850,chunk__14851,count__14852,i__14853,t_14856,temp__5457__auto___14855,v,each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1))
);
} else {
}


var G__14857 = seq__14850;
var G__14858 = chunk__14851;
var G__14859 = count__14852;
var G__14860 = (i__14853 + (1));
seq__14850 = G__14857;
chunk__14851 = G__14858;
count__14852 = G__14859;
i__14853 = G__14860;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14850);
if(temp__5457__auto__){
var seq__14850__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14850__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14850__$1);
var G__14861 = cljs.core.chunk_rest.call(null,seq__14850__$1);
var G__14862 = c__4351__auto__;
var G__14863 = cljs.core.count.call(null,c__4351__auto__);
var G__14864 = (0);
seq__14850 = G__14861;
chunk__14851 = G__14862;
count__14852 = G__14863;
i__14853 = G__14864;
continue;
} else {
var v = cljs.core.first.call(null,seq__14850__$1);
var temp__5457__auto___14865__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14865__$1)){
var t_14866 = temp__5457__auto___14865__$1;
each_fixture_fn.call(null,((function (seq__14850,chunk__14851,count__14852,i__14853,t_14866,temp__5457__auto___14865__$1,v,seq__14850__$1,temp__5457__auto__,each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14866)));
});})(seq__14850,chunk__14851,count__14852,i__14853,t_14866,temp__5457__auto___14865__$1,v,seq__14850__$1,temp__5457__auto__,each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1))
);
} else {
}


var G__14867 = cljs.core.next.call(null,seq__14850__$1);
var G__14868 = null;
var G__14869 = (0);
var G__14870 = (0);
seq__14850 = G__14867;
chunk__14851 = G__14868;
count__14852 = G__14869;
i__14853 = G__14870;
continue;
}
} else {
...
});})(each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1))
);
});})(each_fixture_fn,G__14849,G__14849__$1,env,once_fixtures,each_fixtures,vec__14846,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14849__$1)].join('')));

}
})());
});
;})(vec__14846,ns,vars__$1))
